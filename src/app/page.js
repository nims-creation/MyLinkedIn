            ...
            <div className="container mx-auto px-4 pt-20 pb-32  max-w-7xl">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="relative z-10 bg-white/70 backdrop-blur-xl rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] p-8 border border-white/60">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 group-hover:transform group-hover:-translate-y-2 border border-white/50">
                    <div
